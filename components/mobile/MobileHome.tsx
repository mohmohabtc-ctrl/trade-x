...
export function MobileHome({ user, visits }: MobileHomeProps) {
    ...
    return (
        <div className="flex flex-col min-h-full bg-gray-50 dark:bg-gray-900">
            {/* Header */}
            <header className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white p-4 flex justify-between items-center shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
                <div className="flex items-center gap-2 font-bold text-xl">
                    <div className="bg-red-600 text-white p-1 rounded text-sm">T</div>
                    TradeX
                </div>
                <div className="flex gap-3 items-center">
                    ...
                    <button onClick={handleLogout} className="p-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition" title="Déconnexion">
                        <LogOut size={20} />
                    </button>
                </div>
            </header>
            ...
            <div className="p-4 space-y-6 pb-24">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-1">Bonjour, {user?.name || 'Merchandiser'}</h2>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center">
                        <span className="text-3xl font-bold text-blue-600 dark:text-blue-400">{completedCount}/{totalCount}</span>
                        <span className="text-xs text-gray-500 dark:text-gray-400 mt-1 uppercase tracking-wide">Visites terminées</span>
                    </div>
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center">
                        <span className="text-3xl font-bold text-orange-600 dark:text-orange-400">{nextVisitTime}</span>
                        <span className="text-xs text-gray-500 dark:text-gray-400 mt-1 uppercase tracking-wide">Prochaine visite</span>
                    </div>
                </div>
                ...
                <Link href="/app/add" className="block w-full bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex items-center justify-between group active:scale-95 transition">
                    ...
                    <ChevronLeft size={20} className="transform rotate-180 text-gray-300 dark:text-gray-600 group-hover:text-red-500 transition" />
                </Link>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div className="h-32 bg-gray-100 dark:bg-gray-700 relative">
                        ...
                        <div className="w-full h-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center">
                            <MapPin className="text-slate-300 dark:text-slate-600" size={48} />
                        </div>
                        <div className="absolute inset-0 flex items-center justify-center">
                            {nextVisit && (
                                <div className="bg-white dark:bg-gray-800 px-4 py-2 rounded-full shadow-lg text-sm font-bold flex items-center gap-2 text-gray-800 dark:text-white border border-gray-100 dark:border-gray-600">
                    ...
                    <div className="p-4">
                        <Link href="/app/visits" className="block w-full text-center bg-gray-900 dark:bg-white text-white dark:text-gray-900 py-3 rounded-lg font-bold hover:opacity-90 transition">
                            Voir ma tournée
                        </Link>
                    </div>
                </div>
