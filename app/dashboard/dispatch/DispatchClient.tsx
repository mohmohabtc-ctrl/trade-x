...
export function DispatchClient({ initialVisits, merchandisers, stores }: DispatchClientProps) {
    ...
    const filteredVisits = visits.filter(v => {
        ...
        return v.scheduledStart.startsWith(filterDate);
    });
        ...
        <div className="space-y-6 animate-fade-in">
            ...
            {loading && (
                <div className="text-center py-12">
                    ...
                    <p className="mt-2 text-gray-500 dark:text-gray-400">Chargement du planning...</p>
                </div>
            )}
