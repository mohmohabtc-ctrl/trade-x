...
import { Visit, VisitStatus, MerchandiserProfile } from '@/utils/types';
...
export function DashboardClient({ visits, merchandisers }: DashboardClientProps) {
    ...
    // Note: If 'tasks' column is missing in DB, this will default to 0 or we can use other metrics
    ...
    }).filter(d => d.name); // Filter out undefined names
        ...
        <div className="space-y-8 relative animate-fade-in">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden h-64 relative group">
                ...
                <img
                    ...
                    alt="World Map"
                />
                {/* Fake Pins - could be real if we had lat/lng in visits */}
